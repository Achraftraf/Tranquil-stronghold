...
export default function Events() {
  ...
  const handleRsvpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (rsvpFormData.attendees)
        fullMessage += `Number of Attendees: ${rsvpFormData.attendees}\n`;
      if (rsvpFormData.dietary)
        fullMessage += `Dietary Restrictions: ${rsvpFormData.dietary}\n`;
      if (rsvpFormData.message)
      ...
      if (response.ok) {
        setRsvpStatus({
          type: "success",
          message:
            "RSVP submitted successfully! We'll confirm your registration soon.",
        });
        setRsvpFormData({
          name: "",
          lastName: "",
  ...
  return (
    <section className="w-full min-h-screen bg-white text-black max-w-5xl mx-auto px-8">
      ...
      <AnimatedSection
        delay={0.1}
        classNames="max-w-5xl mx-auto text-center py-10 flex flex-col items-center"
      >
        ...
        <h2 className="text-5xl md:text-7xl font-black tracking-tighter max-w-4xl mb-6 text-gray-900 leading-tight">
          Upcoming{" "}
          <span className="bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-400 bg-clip-text text-transparent drop-shadow-sm pr-2 pb-1">
            Events
          </span>
        </h2>
      ...
      <AnimatedSection delay={0.6}>
        <div
          id="join-us"
          className="w-full mx-auto px-6 pt-10 sm:pt-14 lg:pb-16"
        >
          <div className="text-center mb-8">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-medium">
              Reserve your spot at one of our upcoming events. We'll send you a
